  ...
  return (
    <>
      <button
        ...
        className={cn(
          "group inline-flex shrink-0 items-center gap-2 whitespace-nowrap rounded-md border border-cyan-electric/40 bg-cyan-electric/5 px-4 py-2 font-mono text-xs uppercase tracking-widest text-cyan-electric shadow-glow-cyan transition-all hover:border-magenta-hot/50 hover:text-magenta-hot hover:shadow-glow-dual",
          className
        )}
      >
        <TerminalSquare className="h-3.5 w-3.5 shrink-0" />[ LAUNCH LIVE SANDBOX
